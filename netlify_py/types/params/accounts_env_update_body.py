...
class AccountsEnvUpdateBody(typing_extensions.TypedDict):
    """
...
class _SerializerAccountsEnvUpdateBody(pydantic.BaseModel):
    """
    Serializer for AccountsEnvUpdateBody handling case conversions
