...
class AccountsEnvVarsCreateBodyItem(typing_extensions.TypedDict):
    """
...
class _SerializerAccountsEnvVarsCreateBodyItem(pydantic.BaseModel):
    """
    Serializer for AccountsEnvVarsCreateBodyItem handling case conversions
