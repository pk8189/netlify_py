...
def test_create_204_generated_success():
    """Tests a POST request to the /builds/{build_id}/start endpoint.
    ...
    response = client.builds.start.create(build_id="string")
...
async def test_await_create_204_generated_success():
    ...
    response = await client.builds.start.create(build_id="string")
    assert response is None
