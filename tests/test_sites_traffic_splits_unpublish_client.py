...
def test_create_204_generated_success():
    """Tests a POST request to the /sites/{site_id}/traffic_splits/{split_test_id}/unpublish endpoint.
    ...
    response = client.sites.traffic_splits.unpublish.create(
...
async def test_await_create_204_generated_success():
    ...
    response = await client.sites.traffic_splits.unpublish.create(
        site_id="string", split_test_id="string"
    )
    assert response is None
